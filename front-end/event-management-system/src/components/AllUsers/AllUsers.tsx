...
const AllUsers: React.FC = () => {
    ...
    const handleUpdate = async () => {
        try {
            ...
            formData.append('account_status', updatedUser.isactive === 1 ? 'accepted' : 'pending');
    ...
    const handleEditModalOpen = (user: User) => {
        ...
        setUpdatedUser({
            ...
            profilePicture: null,
            account_status: user.isactive === 1 ? 'accepted' : 'pending'
        });
                ...
                <Modal.Body>
                    <Form>
                        ...
                        <Form.Group controlId="formIsActive">
                            ...
                            <Form.Control
                                as="select"
                                value={updatedUser.isactive.toString()}
                                onChange={(e) => setUpdatedUser({
                                    ...updatedUser,
                                    isactive: parseInt(e.target.value, 10),
                                    account_status: parseInt(e.target.value, 10) === 1 ? 'accepted' : 'pending'
                                })}
                            >
